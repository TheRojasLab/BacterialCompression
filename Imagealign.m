...
dirname={['C:\Users\GuyMa\Documents\Rojas Lab\Exported Movies\' basename '\' basename '_Phase'];
        ['C:\Users\GuyMa\Documents\Rojas Lab\Exported Movies\' basename '\' basename '_GFP']};
regname=['C:\Users\GuyMa\Documents\Rojas Lab\Exported Movies\' basename '\' basename '_Reg' ];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
